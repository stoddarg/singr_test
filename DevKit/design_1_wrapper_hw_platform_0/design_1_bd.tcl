...
CONFIG.FREQ_HZ {250000000} \
  ...
  # Create instance: AA_IntegratorV3_1, and set properties
  set AA_IntegratorV3_1 [ create_bd_cell -type ip -vlnv rmdinc.com:user:AA_IntegratorV3:2.0 AA_IntegratorV3_1 ]

  # Create instance: DFF_0, and set properties
  set DFF_0 [ create_bd_cell -type ip -vlnv rmdinc.com:user:DFF:1.0 DFF_0 ]

  # Create instance: DFF_Integrator_1, and set properties
  set DFF_Integrator_1 [ create_bd_cell -type ip -vlnv rmdinc.com:user:DFF_Integrator:2.0 DFF_Integrator_1 ]

  # Create instance: LPF_Integrator_1, and set properties
  set LPF_Integrator_1 [ create_bd_cell -type ip -vlnv rmdinc.com:user:LPF_Integrator:2.0 LPF_Integrator_1 ]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net AA_IntegratorV3_1_dout [get_bd_pins AA_IntegratorV3_1/dout] [get_bd_pins readout_0/AA]
  connect_bd_net -net AA_IntegratorV3_1_wrcnt [get_bd_pins AA_IntegratorV3_1/wrcnt] [get_bd_pins axi_gpio_11/gpio_io_i]
  connect_bd_net -net DFF_0_dout [get_bd_pins DFF_0/dout] [get_bd_pins c_shift_ram_1/D]
  connect_bd_net -net DFF_Integrator_1_dout [get_bd_pins DFF_Integrator_1/dout] [get_bd_pins readout_0/DFF]
  connect_bd_net -net DFF_Integrator_1_rdcnt [get_bd_pins DFF_Integrator_1/rdcnt] [get_bd_pins axi_gpio_19/gpio_io_i]
  connect_bd_net -net DFF_Integrator_1_wrcnt [get_bd_pins DFF_Integrator_1/wrcnt] [get_bd_pins axi_gpio_13/gpio_io_i]
  connect_bd_net -net LPF_Integrator_1_dout [get_bd_pins LPF_Integrator_1/dout] [get_bd_pins readout_0/LPF]
  ...
  connect_bd_net -net TTL_In_1 [get_bd_ports TTL_In] [get_bd_pins LPF_Integrator_1/ttl_in] [get_bd_pins one_shot_0/D]
  ...
  connect_bd_net -net Trigger_0_we [get_bd_pins AA_IntegratorV3_1/en] [get_bd_pins DFF_Integrator_1/en] [get_bd_pins LPF_Integrator_1/en] [get_bd_pins MUX6_0/EN_A] [get_bd_pins MUX6_0/EN_B] [get_bd_pins MUX6_0/EN_C] [get_bd_pins MUX6_0/EN_D] [get_bd_pins Trigger_0/we]
  ...
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins LPF_Integrator_1/i1s] [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins axi_gpio_4/gpio_io_o]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins LPF_Integrator_1/i2s] [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins axi_gpio_5/gpio_io_o]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins LPF_Integrator_1/i3s] [get_bd_pins axi_gpio_6/gpio_io_i] [get_bd_pins axi_gpio_6/gpio_io_o]
  connect_bd_net -net axi_gpio_7_gpio_io_o [get_bd_pins DFF_Integrator_1/i1s] [get_bd_pins axi_gpio_7/gpio_io_i] [get_bd_pins axi_gpio_7/gpio_io_o]
  connect_bd_net -net axi_gpio_8_gpio_io_o [get_bd_pins DFF_Integrator_1/i2s] [get_bd_pins axi_gpio_8/gpio_io_i] [get_bd_pins axi_gpio_8/gpio_io_o]
  connect_bd_net -net axi_gpio_9_gpio_io_o [get_bd_pins axi_gpio_9/gpio_io_o] [get_bd_pins c_shift_ram_5/D]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins AA_IntegratorV3_1/TotCounts] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net c_shift_ram_0_Q [get_bd_pins AA_IntegratorV3_1/din] [get_bd_pins MUX6_0/A] [get_bd_pins c_shift_ram_0/Q]
  connect_bd_net -net c_shift_ram_1_Q [get_bd_pins DFF_Integrator_1/din] [get_bd_pins MUX6_0/C] [get_bd_pins c_shift_ram_1/Q]
  connect_bd_net -net c_shift_ram_2_Q [get_bd_pins MUX6_0/D] [get_bd_pins c_shift_ram_2/Q]
  connect_bd_net -net c_shift_ram_3_Q [get_bd_pins LPF_Integrator_1/din] [get_bd_pins MUX6_0/B] [get_bd_pins c_shift_ram_3/Q]
  connect_bd_net -net c_shift_ram_4_Q [get_bd_pins AA_IntegratorV3_1/rst] [get_bd_pins DFF_Integrator_1/rst] [get_bd_pins LPF_Integrator_1/rst] [get_bd_pins c_shift_ram_4/Q]
  connect_bd_net -net c_shift_ram_6_Q [get_bd_pins AA_IntegratorV3_1/i1s] [get_bd_pins c_shift_ram_6/Q]
  connect_bd_net -net c_shift_ram_7_Q [get_bd_pins AA_IntegratorV3_1/i2s] [get_bd_pins c_shift_ram_7/Q]
  connect_bd_net -net c_shift_ram_8_Q [get_bd_pins AA_IntegratorV3_1/i3s] [get_bd_pins c_shift_ram_8/Q]
  connect_bd_net -net c_shift_ram_9_Q [get_bd_pins AA_IntegratorV3_1/i4s] [get_bd_pins c_shift_ram_9/Q]
  connect_bd_net -net capture_0_clkout [get_bd_pins AA_0/clk] [get_bd_pins AA_IntegratorV3_1/clk] [get_bd_pins DFF_0/clk] [get_bd_pins DFF_Integrator_1/clk] [get_bd_pins LPF_Integrator_1/clk] [get_bd_pins MUX6_0/clk] [get_bd_pins Master_Slave_Stream_v1_0_0/wrclk] [get_bd_pins TriggerV2_0/clk] [get_bd_pins Trigger_0/clk] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins c_shift_ram_1/CLK] [get_bd_pins c_shift_ram_2/CLK] [get_bd_pins c_shift_ram_3/CLK] [get_bd_pins c_shift_ram_4/CLK] [get_bd_pins c_shift_ram_5/CLK] [get_bd_pins capture_0/clkout] [get_bd_pins gater_0/clk] [get_bd_pins lpf_0/clk] [get_bd_pins mult_gen_0/CLK] [get_bd_pins mult_gen_1/CLK] [get_bd_pins one_shot_0/clk] [get_bd_pins readout_0/clk]
  ...
  connect_bd_net -net memReset_0_rst [get_bd_pins AA_IntegratorV3_1/clr] [get_bd_pins DFF_Integrator_1/clr] [get_bd_pins LPF_Integrator_1/clr] [get_bd_pins c_shift_ram_5/Q] [get_bd_pins gater_0/rst2]
  ...
  connect_bd_net -net one_shot_0_Q [get_bd_pins LPF_Integrator_1/ttl_on] [get_bd_pins one_shot_0/Q] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net one_shot_0_Qn [get_bd_pins LPF_Integrator_1/ttl_off] [get_bd_pins one_shot_0/Qn] [get_bd_pins util_vector_logic_0/Op2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins DFF_Integrator_1/timer_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net readout_0_dout [get_bd_pins MUX6_0/E] [get_bd_pins readout_0/dout]
  connect_bd_net -net readout_0_en_a [get_bd_pins AA_IntegratorV3_1/rden] [get_bd_pins readout_0/en_a]
  connect_bd_net -net readout_0_en_d [get_bd_pins DFF_Integrator_1/rden] [get_bd_pins readout_0/en_d]
  connect_bd_net -net readout_0_en_l [get_bd_pins LPF_Integrator_1/rden] [get_bd_pins readout_0/en_l]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -y 2110 -defaultsOSRD
preplace port clkin_p -pg 1 -y 2170 -defaultsOSRD
preplace port TTL_In -pg 1 -y 1850 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 2130 -defaultsOSRD
preplace port clkin_n -pg 1 -y 2190 -defaultsOSRD
preplace portBus din_n -pg 1 -y 2250 -defaultsOSRD
preplace portBus din_p -pg 1 -y 2230 -defaultsOSRD
preplace inst c_shift_ram_4 -pg 1 -lvl 7 -y 2240 -defaultsOSRD
preplace inst axi_gpio_10 -pg 1 -lvl 13 -y 1660 -defaultsOSRD
preplace inst axi_gpio_8 -pg 1 -lvl 13 -y 1120 -defaultsOSRD
preplace inst Trigger_0 -pg 1 -lvl 6 -y 2410 -defaultsOSRD
preplace inst MUX6_0 -pg 1 -lvl 10 -y 2280 -defaultsOSRD
preplace inst c_shift_ram_5 -pg 1 -lvl 7 -y 2340 -defaultsOSRD
preplace inst axi_gpio_11 -pg 1 -lvl 13 -y 1390 -defaultsOSRD
preplace inst axi_gpio_9 -pg 1 -lvl 13 -y 2500 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 13 -y 2210 -defaultsOSRD
preplace inst TriggerV2_0 -pg 1 -lvl 6 -y 1950 -defaultsOSRD
preplace inst LPF_Integrator_0 -pg 1 -lvl 8 -y 1840 -defaultsOSRD
preplace inst AA_IntegratorV3_0 -pg 1 -lvl 8 -y 1500 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 2300 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 11 -y 1760 -defaultsOSRD
preplace inst gater_0 -pg 1 -lvl 11 -y 2380 -defaultsOSRD
preplace inst c_shift_ram_6 -pg 1 -lvl 7 -y 1210 -defaultsOSRD
preplace inst axi_gpio_12 -pg 1 -lvl 13 -y 1240 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 11 -y 2560 -defaultsOSRD
preplace inst capture_0 -pg 1 -lvl 2 -y 2210 -defaultsOSRD
preplace inst c_shift_ram_7 -pg 1 -lvl 7 -y 1310 -defaultsOSRD
preplace inst axi_gpio_13 -pg 1 -lvl 13 -y 1970 -defaultsOSRD
preplace inst fit_timer_0 -pg 1 -lvl 13 -y 2360 -defaultsOSRD
preplace inst c_shift_ram_8 -pg 1 -lvl 7 -y 1510 -defaultsOSRD
preplace inst axi_gpio_14 -pg 1 -lvl 13 -y 2650 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 14 -y 2360 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 4 -y 2350 -defaultsOSRD
preplace inst mult_gen_0 -pg 1 -lvl 5 -y 2110 -defaultsOSRD
preplace inst c_shift_ram_9 -pg 1 -lvl 7 -y 1410 -defaultsOSRD
preplace inst axi_gpio_15 -pg 1 -lvl 13 -y 1520 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 13 -y 60 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 5 -y 2370 -defaultsOSRD
preplace inst mult_gen_1 -pg 1 -lvl 5 -y 2220 -defaultsOSRD
preplace inst c_counter_binary_0 -pg 1 -lvl 7 -y 1600 -defaultsOSRD
preplace inst axi_gpio_16 -pg 1 -lvl 13 -y 2910 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 13 -y 200 -defaultsOSRD
preplace inst one_shot_0 -pg 1 -lvl 3 -y 2110 -defaultsOSRD
preplace inst axi_gpio_17 -pg 1 -lvl 13 -y 3050 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 13 -y 340 -defaultsOSRD
preplace inst readout_0 -pg 1 -lvl 9 -y 2010 -defaultsOSRD
preplace inst axi_gpio_18 -pg 1 -lvl 13 -y 2790 -defaultsOSRD
preplace inst axi_gpio_3 -pg 1 -lvl 13 -y 480 -defaultsOSRD
preplace inst DFF_Integrator_0 -pg 1 -lvl 8 -y 2150 -defaultsOSRD
preplace inst c_shift_ram_0 -pg 1 -lvl 7 -y 1720 -defaultsOSRD
preplace inst axi_gpio_19 -pg 1 -lvl 13 -y 1810 -defaultsOSRD
preplace inst axi_gpio_4 -pg 1 -lvl 13 -y 620 -defaultsOSRD
preplace inst Master_Slave_Stream_v1_0_0 -pg 1 -lvl 12 -y 2610 -defaultsOSRD
preplace inst c_shift_ram_1 -pg 1 -lvl 7 -y 2040 -defaultsOSRD
preplace inst axi_gpio_5 -pg 1 -lvl 13 -y 760 -defaultsOSRD
preplace inst lpf_0 -pg 1 -lvl 6 -y 2220 -defaultsOSRD
preplace inst c_shift_ram_2 -pg 1 -lvl 9 -y 2390 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 14 -y 2180 -defaultsOSRD
preplace inst axi_gpio_6 -pg 1 -lvl 13 -y 880 -defaultsOSRD
preplace inst AA_0 -pg 1 -lvl 4 -y 2210 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 12 -y 1330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 15 -y 2200 -defaultsOSRD
preplace inst c_shift_ram_3 -pg 1 -lvl 7 -y 2140 -defaultsOSRD
preplace inst axi_gpio_7 -pg 1 -lvl 13 -y 1000 -defaultsOSRD
preplace inst DFF_0 -pg 1 -lvl 6 -y 2090 -defaultsOSRD
preplace netloc axi_gpio_6_gpio_io_o 1 7 7 1610 2000 NJ 2120 NJ 2070 NJ 2070 NJ 2070 NJ 2070 3720
preplace netloc axi_gpio_14_gpio_io_o 1 9 5 2200 2480 NJ 2480 NJ 2450 NJ 2720 3680
preplace netloc processing_system7_0_axi_periph_M08_AXI 1 12 1 3310
preplace netloc c_shift_ram_0_Q 1 7 3 1450 1680 NJ 1680 2190
preplace netloc util_vector_logic_0_Res 1 4 1 730
preplace netloc processing_system7_0_FIXED_IO 1 15 1 NJ
preplace netloc processing_system7_0_axi_periph_M17_AXI 1 12 1 3240
preplace netloc axi_gpio_1_gpio_io_o 1 6 8 1250 410 NJ 410 NJ 410 NJ 410 NJ 410 NJ 410 NJ 410 3700
preplace netloc fit_timer_0_Interrupt 1 13 1 3760
preplace netloc xlconcat_1_dout 1 5 1 940
preplace netloc clkin_p_1 1 0 2 NJ 2170 NJ
preplace netloc MUX6_0_dout 1 10 2 NJ 2300 2840
preplace netloc xlconcat_0_dout 1 14 1 4080
preplace netloc axi_gpio_3_gpio_io_o 1 6 8 1260 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 3690
preplace netloc axi_gpio_18_gpio_io_o 1 1 13 150 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 NJ 2980 3680
preplace netloc processing_system7_0_axi_periph_M18_AXI 1 12 1 3210
preplace netloc axi_gpio_9_gpio_io_o 1 6 8 1270 2470 NJ 2470 NJ 2470 NJ 2470 NJ 2470 NJ 2420 NJ 2430 3680
preplace netloc processing_system7_0_axi_periph_M16_AXI 1 12 1 3320
preplace netloc mult_gen_0_P 1 5 1 940
preplace netloc processing_system7_0_axi_periph_M06_AXI 1 12 1 3260
preplace netloc Trigger_1_dout 1 6 3 NJ 2400 NJ 2380 N
preplace netloc processing_system7_0_DDR 1 15 1 NJ
preplace netloc MUX6_0_logic_out 1 10 2 NJ 2260 2850
preplace netloc c_counter_binary_0_Q 1 7 1 NJ
preplace netloc axi_gpio_17_gpio_io_o 1 11 3 2880 2440 NJ 2580 3700
preplace netloc c_shift_ram_7_Q 1 7 1 1540
preplace netloc din_n_1 1 0 2 NJ 2250 NJ
preplace netloc lpf_0_dout 1 6 1 1240
preplace netloc AA_IntegratorV3_0_wrcnt 1 8 6 1900 810 NJ 810 NJ 810 NJ 810 NJ 1590 3690
preplace netloc capture_0_clkout 1 2 10 370 2190 540 2280 730 2040 960 1880 1250 1960 1530 2010 1870 2160 2200 2120 2420 2490 NJ
preplace netloc Trigger_0_event_done 1 6 5 1260 2430 NJ 2430 NJ 2460 NJ 2460 2400
preplace netloc axi_gpio_10_gpio_io_o 1 5 9 980 1660 NJ 1660 NJ 1670 NJ 1670 NJ 1670 NJ 1670 NJ 1850 NJ 1730 3690
preplace netloc xlconstant_1_dout 1 11 1 NJ
preplace netloc processing_system7_0_axi_periph_M05_AXI 1 12 1 3240
preplace netloc axi_gpio_16_gpio_io_o 1 11 3 2890 3120 NJ 3120 3690
preplace netloc readout_0_en_a 1 7 3 1610 1650 NJ 1650 2080
preplace netloc processing_system7_0_axi_periph_M20_AXI 1 12 1 3270
preplace netloc processing_system7_0_FCLK_RESET0_N 1 10 6 2470 2090 NJ 2090 NJ 2090 NJ 2050 NJ 2050 4520
preplace netloc axi_gpio_15_gpio_io_o 1 8 6 1900 2150 NJ 2090 NJ 2100 NJ 2100 NJ 2100 3700
preplace netloc c_shift_ram_4_Q 1 7 1 1470
preplace netloc processing_system7_0_axi_periph_M10_AXI 1 12 1 3310
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 12 1 3210
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 12 1 3200
preplace netloc readout_0_en_d 1 7 3 1610 2320 NJ 2320 2080
preplace netloc processing_system7_0_axi_periph_M07_AXI 1 12 1 3300
preplace netloc readout_0_dout 1 9 1 2130
preplace netloc lpf_0_L_n1 1 4 3 750 2300 NJ 2300 1200
preplace netloc c_shift_ram_2_Q 1 9 1 2080
preplace netloc din_p_1 1 0 2 NJ 2230 NJ
preplace netloc mult_gen_1_P 1 5 1 940
preplace netloc processing_system7_0_axi_periph_M09_AXI 1 12 1 3320
preplace netloc Trigger_0_we 1 6 4 NJ 1980 1490 2280 NJ 2250 2200
preplace netloc capture_0_dout 1 2 2 NJ 2200 530
preplace netloc processing_system7_0_axi_periph_M11_AXI 1 12 1 3340
preplace netloc c_shift_ram_9_Q 1 7 1 1520
preplace netloc processing_system7_0_axi_periph_M13_AXI 1 12 1 3210
preplace netloc axi_dma_0_M_AXI_S2MM 1 13 1 3770
preplace netloc processing_system7_0_axi_periph_M19_AXI 1 12 1 3220
preplace netloc one_shot_0_Q 1 3 5 550 1870 NJ 1870 NJ 1870 NJ 1870 NJ
preplace netloc processing_system7_0_axi_periph_M12_AXI 1 12 1 N
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 12 1 3190
preplace netloc capture_0_load 1 2 4 NJ 2210 510 2290 NJ 2290 950
preplace netloc gater_0_rst 1 11 1 2810
preplace netloc DFF_Integrator_0_rdcnt 1 8 6 NJ 2130 NJ 2050 NJ 2050 NJ 2050 NJ 2050 3690
preplace netloc readout_0_en_l 1 7 3 1570 2290 NJ 2280 2100
preplace netloc processing_system7_0_FCLK_CLK0 1 6 10 1210 1150 NJ 1150 NJ 1150 NJ 1150 2470 1150 2800 800 3280 2120 3760 2300 4070 2340 4510
preplace netloc clkin_n_1 1 0 2 NJ 2190 NJ
preplace netloc processing_system7_0_FCLK_CLK1 1 7 9 1580 2330 NJ 2330 NJ 2100 NJ 2110 NJ 2110 NJ 2110 NJ 2060 NJ 2060 4500
preplace netloc memReset_0_rst 1 7 4 1500 2340 NJ 2270 NJ 2110 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 11 3 2880 1860 NJ 2300 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 12 1 3330
preplace netloc c_shift_ram_8_Q 1 7 1 1510
preplace netloc axi_gpio_7_gpio_io_o 1 7 7 1590 2450 NJ 2450 NJ 2440 NJ 2460 NJ 2410 NJ 2420 3730
preplace netloc MUX6_0_en_integration 1 10 1 2430
preplace netloc readout_0_we 1 9 1 2180
preplace netloc one_shot_0_Qn 1 3 5 520 1860 NJ 1860 NJ 1860 NJ 1860 NJ
preplace netloc axi_gpio_5_gpio_io_o 1 7 7 1560 690 NJ 690 NJ 690 NJ 690 NJ 690 NJ 690 3690
preplace netloc LPF_Integrator_0_dout 1 8 1 1880
preplace netloc AA_0_dout 1 4 3 740 2030 970 1710 NJ
preplace netloc c_shift_ram_1_Q 1 7 3 1450 2300 NJ 2300 NJ
preplace netloc processing_system7_0_axi_periph_M14_AXI 1 12 1 3200
preplace netloc AA_IntegratorV3_0_dout 1 8 1 1890
preplace netloc lpf_0_CE_O 1 4 3 750 2020 NJ 2020 1210
preplace netloc axi_gpio_4_gpio_io_o 1 7 7 1600 790 NJ 790 NJ 790 NJ 790 NJ 790 NJ 1310 3700
preplace netloc Master_Slave_Stream_v1_0_0_m00_axis 1 12 1 3360
preplace netloc TTL_In_1 1 0 8 NJ 1850 NJ 1850 370 1840 NJ 1840 NJ 1840 NJ 1840 NJ 1840 NJ
preplace netloc DFF_0_dout 1 6 1 1220
preplace netloc DFF_Integrator_0_dout 1 8 1 1840
preplace netloc xlconstant_0_dout 1 1 1 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 14 1 N
preplace netloc axi_gpio_0_gpio_io_o 1 6 8 1230 1650 NJ 1660 NJ 1660 NJ 1660 NJ 1660 NJ 1890 NJ 1890 3760
preplace netloc axi_gpio_8_gpio_io_o 1 7 7 1600 2020 NJ 2110 NJ 2080 NJ 2080 NJ 2080 NJ 2080 3710
preplace netloc DFF_Integrator_0_wrcnt 1 8 6 NJ 2140 NJ 2060 NJ 2060 NJ 2060 NJ 2060 3680
preplace netloc axi_dma_0_s2mm_introut 1 13 1 3750
preplace netloc processing_system7_0_axi_periph_M15_AXI 1 12 1 3260
preplace netloc processing_system7_0_axi_periph_M04_AXI 1 12 1 3220
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 11 3 2820 770 3290 2570 3770
preplace netloc axi_gpio_2_gpio_io_o 1 6 8 1200 270 NJ 270 NJ 270 NJ 270 NJ 270 NJ 270 NJ 270 3690
preplace netloc TriggerV2_0_we 1 6 1 1200
preplace netloc c_shift_ram_6_Q 1 7 1 1550
preplace netloc S00_AXI_1 1 11 5 2880 130 NJ 130 NJ 130 NJ 130 4510
preplace netloc c_shift_ram_3_Q 1 7 3 1550 2310 NJ 2310 NJ
levelinfo -pg 1 0 80 260 440 640 850 1090 1360 1720 1990 2300 2630 3040 3520 3920 4290 4540 -top 0 -bot 3130
",
}
